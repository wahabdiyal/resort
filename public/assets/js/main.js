...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.datepicker').datepicker({
            ...
            endDate: "18/12/2022", //Set Max Date
            datesDisabled: [
               //php condition code
                '16/04/2022',
                '17/04/2022',
        ...
        $("#booking-form, #horizontal_booking_form, #booking_form_advanced").on('submit', function (e) {
            ...
            $.post('api/booking', post_data, function (response) {
        ...
        $("#contact-form, #contact-form-page").on('submit', function (e) {
            ...
            //Ajax post data to server
            $.post('api/subcribe', post_data, function (response) {
       ...
       $("#subscribe-form").on('submit', function (e) {
        ...
        function initialize() {
            var map;
            var panorama;
            var var_latitude = 31.455350; // Google Map Latitude
            var var_longitude = 74.275066; // Google Map Longitude
            var pin = 'assets/images/icons/pin.svg';

            //Map pin-window details
            var title = "NexaSolution - Click to see";
            var hotel_name = "Nexasolution";
            var hotel_address = "821, Johr town, Lahore";
            var hotel_desc = "5 star Resort";
            var hotel_more_desc = "For more detail visit.";
